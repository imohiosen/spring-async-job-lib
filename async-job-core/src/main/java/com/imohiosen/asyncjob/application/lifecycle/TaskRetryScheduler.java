 ...
 * passed and re-publishes them for retry.
 *
 ...
 *
 * <p>Configured via {@code asyncjob.retry.sweep-interval-ms} (default: 15 000ms)
...
public class TaskRetryScheduler {
    ...
    /**
     * Sweeps for retryable tasks and re-publishes them.
